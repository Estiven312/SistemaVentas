        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <a href="lista-producto.php" class="btn btn-primary mr-2">Listado</a>
                    ...
                    <select name="lstTipoProducto" id="lstTipoProducto" class="form-control selectpicker" data-live-search="true" required>
                        ...
                        <?php foreach ($aTipoProductos as $tipoProducto) : ?>
                            <?php if ($producto->fk_idtipoproducto == $tipoProducto->idtipoproducto) : ?>
                                <option selected value="<?php echo $tipoProducto->idtipoproducto; ?>"><?php echo $tipoProducto->nombre . $tipoProducto->idtipoproducto; ?></option>
                            <?php else : ?>
