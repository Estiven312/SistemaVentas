      ...
      <li class="nav-item">
        ...
        <div id="collapseProductos" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="lista-producto.php">Listado de productos</a>
            <a class="collapse-item" href="tipoproducto-formulario.php">Tipo de productos</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUsuario" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="lista-usuarios.php">Listado de usuarios</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
